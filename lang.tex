...
is subject to the finite set $\cts$ of constraints  ranging over a fixed universe of constraints $\cset$. We assume the function $\fv : \cset\rightarrow\finPart(\varSet)$ associating with each constraint $\ct$ the finite set of variables $\fv(\ct)$ occurring in it.

\begin{figure}
 $$
  \begin{array}{c}
   \hasEps{\eps}=\hasEps{\starop{\re_0}}=\true                                                                                                                                                       \\                                                                                                      \hasEps{\none}=\hasEps{\sym}=\hasEps{\var}=\false \\
